...
describe PermalinkRedirector do
  let_it_be(:remote_account) { Fabricate(:account, username: 'alice', domain: 'example.com', url: 'https://example.com/@alice', id: 2) }
  let_it_be(:remote_status) { Fabricate(:status, account: remote_account, id: 123, url: 'https://example.com/status-123') }
