...
require 'test_prof/recipes/let_it_be' # Ensure let_it_be is available

RSpec.describe BackupService, type: :model do
  ...
  def process_backup
    expect(backup).to receive(:processed!).and_call_original
  end
